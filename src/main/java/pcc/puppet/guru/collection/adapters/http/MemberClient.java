...
import static pcc.puppet.guru.configuration.HttpHeaders.DEPARTMENT;
...
public interface MemberClient {
  ...
  Mono<MemberCreateResponse> memberCreate(
      ...
      @NonNull @Valid @Body MemberCreateRequest createCommand);

  @Get(uri = "/{memberId}", consumes = MediaType.APPLICATION_JSON)
  Mono<MemberResponse> findMember(
      @SpanTag(REQUESTER) @NonNull @Header(REQUESTER) String requester,
      @SpanTag(ORGANIZATION) @NonNull @Header(ORGANIZATION) String organizationId,
      @SpanTag(DEPARTMENT) @NonNull @Header(DEPARTMENT) String departmentId,
  ...
  Flux<MemberResponse> findOrganizationMembers(
      @SpanTag(REQUESTER) @NonNull @Header(REQUESTER) String requester,
      @SpanTag(ORGANIZATION) @NonNull @Header(ORGANIZATION) String organizationId,
      @SpanTag(DEPARTMENT) @NonNull @Header(DEPARTMENT) String departmentId,
  ...
  Flux<MemberResponse> findDepartmentMembers(
      @SpanTag(REQUESTER) @NonNull @Header(REQUESTER) String requester,
      @SpanTag(ORGANIZATION) @NonNull @Header(ORGANIZATION) String organizationId,
      @SpanTag(DEPARTMENT) @NonNull @Header(DEPARTMENT) String departmentId,
