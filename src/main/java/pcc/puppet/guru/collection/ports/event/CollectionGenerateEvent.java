 ...
 */
package pcc.puppet.guru.collection.ports.event;
...
public class CollectionGenerateEvent extends Message<CollectionGenerateResponse> {
  public static final String NAME = "collection-generate-event";
  public static final String VERSION = "1.0.0";

  public static CollectionGenerateEventBuilder<?, ?> builder() {
    return innerBuilder()
        .id(Xid.string())
        .name(NAME)
